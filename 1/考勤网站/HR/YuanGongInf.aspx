<%@ Page Title="" Language="C#" MasterPageFile="~/HR/HRadmin.master" AutoEventWireup="true" CodeFile="YuanGongInf.aspx.cs" Inherits="admin_YuanGongInf" %>
    ...
    <div style="margin-left: 40px; text-align: center">
        <table style="width: 90%;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="u_bumen" runat="server"></asp:TextBox>
            ...
            <tr>
             ...
             <tr>
                ...
                <td>
                 ...
                 <td>
                    <asp:TextBox ID="ruzhi" runat="server"></asp:TextBox>
      ...
      <%--           <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownList6" runat="server" Width="150px">
                        <asp:ListItem>T技术</asp:ListItem>
                         <asp:ListItem>M非技术</asp:ListItem>
                         <asp:ListItem>W操作</asp:ListItem>
                ...
                <td>
                    <asp:DropDownList ID="DropDownList1" runat="server" Width="150px">
                        <asp:ListItem>无</asp:ListItem>
                         <asp:ListItem>见习首席师</asp:ListItem>
                         <asp:ListItem>一级首席师</asp:ListItem>
                         <asp:ListItem>二级首席师</asp:ListItem>
                          <asp:ListItem>三级首席师</asp:ListItem>
                    </asp:DropDownList>
                </td>
                ...
                <td>
                    <asp:DropDownList ID="DropDownList2" runat="server" Width="150px">
                        <asp:ListItem>无</asp:ListItem>
                         <asp:ListItem>一般涉密</asp:ListItem>
                         <asp:ListItem>技术涉密</asp:ListItem>
                         <asp:ListItem>军工涉密</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
              <tr>
        ...
        <table border="0" align="right" cellpadding="0" cellspacing="0">
            ...
            <asp:GridView ID="gvShow" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="bumen" HeaderText="部门" SortExpression="bumen" />
                    ...
                    <asp:BoundField DataField="ruzhi" HeaderText="入职" SortExpression="ruzhi" />
