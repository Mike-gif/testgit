...
public partial class HR_hr_password : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (GetMD5(password1.Text) == password && password2.Text == password3.Text)
        {
            ...
            string sql1 = "update [user] set password=@password where type='HR'";
            ...
            if (a > 0)
            {
                ...
                Response.Write("<script>alert('修改成功');window.location='hr_password.aspx';</script>");
            }
