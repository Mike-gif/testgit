<%@ Page Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="edit_ManegeKaoHe_Zhoujihua.aspx.cs" Inherits="user_edit_ManegeKaoHe_Zhoujihua" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="position">
    <div style="padding-left: 10px; padding-top: 15px">
        当前位置：下属信息管理&nbsp;&gt;&gt;&nbsp;管理工作考核&nbsp;&gt;&gt;&nbsp;下属周计划批阅</div>
</asp:Content>
    ...
    <div style="margin-left: 40px; text-align: center" id="div_cont">
        ...
        <table style="width: 90%; padding-top: 5px; text-align:center ">
           ...
           <tr>
               ...
               <td  style= "width: 150px">
                    <asp:TextBox ID="z_pingyu" runat="server" TextMode="MultiLine"  Height="80px" Width="250px"></asp:TextBox>

                </td>
                <td style= "width: 80px">
                    <asp:Button ID="lbSubmitAddzhou" runat="server" Text="批 阅"  class="buttonSubmit" Width="80px" OnClick="lbSubmitAddzhou_Click" OnClientClick="return checkdatazhou()"/>
         ...
         <table style="width: 90%; padding-top: 5px; text-align:center ">
            ...
            <tr>
                ...
                <td style="width: 100px" >
                    <asp:TextBox ID="r_time" runat="server" ReadOnly="true"  Width="80px" align="center" BackColor="#EEEEEE" Height="22px"></asp:TextBox>
                ...
                <td style= "width: 150px">
                    <asp:TextBox ID="r_jihua" runat="server" TextMode="MultiLine" onkeyup="checklength4(this) " Height="80px" Width="250px" BackColor="#EEEEEE" ReadOnly="True"></asp:TextBox>
                </td>
                <td style= "width: 150px">
                    <asp:TextBox ID="r_mubiao" runat="server" TextMode="MultiLine" onkeyup="checklength5(this)" Height="80px" Width="250px" BackColor="#EEEEEE" ReadOnly="True"></asp:TextBox>

                </td>
                <td style= "width:50px">
                    <asp:TextBox ID="r_gongshi" runat="server" TextMode="MultiLine" Height="80px" Width="50px" BackColor="#EEEEEE" ReadOnly="True"></asp:TextBox>
                </td>
                <td style= "width: 150px">
                    <asp:TextBox ID="r_neirong" runat="server" TextMode="MultiLine" onkeyup="checklength6(this)" Height="80px" Width="250px" BackColor="#EEEEEE" ReadOnly="True"></asp:TextBox>
                </td>
                <td style= "width:50px">
                    <asp:TextBox ID="r_jieguo" runat="server" TextMode="MultiLine" Height="80px" Width="50px" BackColor="#EEEEEE" ReadOnly="True"></asp:TextBox>
                </td>
                 <td style= "width: 150px">
                    <asp:TextBox ID="r_pingyu" runat="server" TextMode="MultiLine" onkeyup="checklength6(this)" Height="80px" Width="250px" BackColor="#EEEEEE" ReadOnly="True"></asp:TextBox>
                </td>
                <td style= "width:50px">
                    <asp:TextBox ID="r_defen" runat="server" TextMode="MultiLine" Height="80px" Width="50px" BackColor="#EEEEEE" ReadOnly="True"></asp:TextBox>
                </td>
                <td  style= "width: 80px">
  
                     <asp:Button ID="lbSubmitAddri" runat="server" Text="批 阅"  class="buttonSubmit" Width="80px"  BackColor="#EEEEEE"/>
                </td>
            </tr>
