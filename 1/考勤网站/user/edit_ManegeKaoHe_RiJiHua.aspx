<%@ Page Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="edit_ManegeKaoHe_RiJiHua.aspx.cs" Inherits="user_edit_ManegeKaoHe_RiJiHua" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="position">
    <div style="padding-left: 10px; padding-top: 15px">
        当前位置：下属信息管理&nbsp;&gt;&gt;&nbsp;管理工作考核&nbsp;&gt;&gt;&nbsp;下属日计划批阅</div>
</asp:Content>
        ...
        <table style="width: 90%; padding-top: 5px; text-align:center ">
           ...
           <tr>
                ...
                <td  style="width: 100px"  >
                    <asp:TextBox ID="z_time" runat="server" ReadOnly="true" Width="80px" align="center" BackColor="#EEEEEE"></asp:TextBox>
                ...
                <td  style= "width: 150px">
                    <asp:TextBox ID="z_jihua" runat="server" TextMode="MultiLine" onkeyup="checklength1(this) " Height="80px"  Width="250px" BackColor="#EEEEEE" ReadOnly="True"></asp:TextBox>
                </td>
                <td  style= "width: 150px">
                    <asp:TextBox ID="z_mubiao" runat="server" TextMode="MultiLine" onkeyup="checklength2(this)" Height="80px" Width="250px" BackColor="#EEEEEE" ReadOnly="True"></asp:TextBox>

                </td>
                <td style= "width: 50px">
                    <asp:TextBox ID="z_zhanbi" runat="server" TextMode="MultiLine" Height="80px" Width="50px" BackColor="#EEEEEE" ReadOnly="True"></asp:TextBox>
                </td>
                <td style= "width: 150px">
                    <asp:TextBox ID="z_shishiqingkuang" runat="server" TextMode="MultiLine" onkeyup="checklength3(this)" Height="80px" Width="250px" BackColor="#EEEEEE" ReadOnly="True"></asp:TextBox>
                </td>
                <td style= "width: 50px">
                    <asp:TextBox ID="z_jieguo" runat="server" TextMode="MultiLine" Height="80px" Width="50px" BackColor="#EEEEEE" ReadOnly="True"></asp:TextBox>
                </td>
               <td  style= "width: 150px">
                    <asp:TextBox ID="z_pingyu" runat="server" TextMode="MultiLine"  Height="80px" Width="250px" BackColor="#EEEEEE" ReadOnly="True"></asp:TextBox>

                </td>
                <td style= "width: 80px">
                    <asp:Button ID="lbSubmitAddzhou" runat="server" Text="批 阅"  class="buttonSubmit" Width="80px" BackColor="#EEEEEE"/>
         ...
         <table style="width: 90%; padding-top: 5px; text-align:center ">
            ...
            <tr>
                ...
                <td style="width: 100px" >
                    <asp:TextBox ID="r_time" runat="server" ReadOnly="true"  Width="80px" align="center" Height="22px"></asp:TextBox>
                ...
                <td style= "width:50px">
                 ...
                 <td style= "width: 150px">
                    <asp:TextBox ID="r_pingyu" runat="server" TextMode="MultiLine" onkeyup="checklength6(this)" Height="80px" Width="250px"></asp:TextBox>
                </td>
                <td style= "width:50px">
                    <asp:TextBox ID="r_defen" runat="server" TextMode="MultiLine" Height="80px" Width="50px" onkeypress="return(LimitNum())" style="ime-mode:disabled" onpaste="return false"></asp:TextBox>
                </td>
                <td  style= "width: 80px">
  
                     <asp:Button ID="lbSubmitAddri" runat="server" Text="批 阅"  class="buttonSubmit"  OnClick="lbSubmitAddri_Click" Width="80px"/>
                </td>
            </tr>
        ...
        <table style="width: 90%; padding-top: 5px; text-align:center ">    
            ...
            <tr>
                 <td  style="width: 100px"  >
                    ...
                    <asp:DropDownList ID="ddl_shixiang" runat="server" Width="100px" BackColor="#EEEEEE" ViewStateMode="Disabled">
                ...
                <td style="width: 140px">
                    ...
                    <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click">打开日历</asp:LinkButton>
                     <br />
                    <asp:TextBox ID="startdate" runat="server" Width="100px" ReadOnly="true" BackColor="#EEEEEE"></asp:TextBox>
                     <br />
                    <asp:DropDownList ID="time11_d1" runat="server" BackColor="#EEEEEE">
          
                    </asp:DropDownList>
                    :
                    <asp:DropDownList ID="time11_d2" runat="server" BackColor="#EEEEEE">
                ...
                <td style="width: 140px">
                    ...
                    <br />
                     <asp:TextBox ID="enddate" runat="server" Width="100px" ReadOnly="true" BackColor="#EEEEEE" ></asp:TextBox>
                     <br />   
                    <asp:DropDownList ID="time12_d1" runat="server" BackColor="#EEEEEE">
          
                    </asp:DropDownList>
                    :
                    <asp:DropDownList ID="time12_d2" runat="server" BackColor="#EEEEEE" >
     
                    </asp:DropDownList>
                </td>
                 <td style="width: 250px">
                   <asp:TextBox ID="thing" runat="server" TextMode="MultiLine" onkeyup= "checklength7(this) " Height="100px" style="margin-left: 0px" Width="250px" BackColor="#EEEEEE" ReadOnly="True" ></asp:TextBox>
                </td>
                <td style="width: 200px">
                   <asp:TextBox ID="tianall" runat="server"  onkeypress="return(LimitNum())" style="ime-mode:disabled" onpaste="return false" Width="50px" BackColor="#EEEEEE" ReadOnly="True"></asp:TextBox>(天、小时)
                     <br />   
                    <br />
                ...
                <td style="width: 80px">
                    <asp:Button ID="lbSubmitAddshenqing" runat="server" Text="修改" class="buttonSubmit" Width="80px"  BackColor="#EEEEEE" ViewStateMode="Disabled" />
                </td>
