<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="edit_ShenQingShenBao_RiJiHua.aspx.cs" Inherits="user_edit_ShenQingShenBao_RiJiHua" %>
    ...
    <div style="margin-left: 40px; text-align: center" id="div_cont">
        ...
        <table style="width: 90%; padding-top: 5px; text-align:center ">
           ...
           <tr>
                ...
                <td style= "width: 80px">
                    <asp:Button ID="lbSubmitAddzhou" runat="server" Text="修 改"  class="buttonSubmit" Width="80px" BorderColor="#EEEEEE" BackColor="#EEEEEE" />
        ...
        <table style="width: 90%; padding-top: 5px; text-align:center ">    
            ...
            <tr>
                 <td  style="width: 100px"  >
                    ...
                    <asp:DropDownList ID="ddl_shixiang" runat="server" Width="100px" BackColor="#EEEEEE">
                ...
                <td style="width: 80px">
                    <asp:Button ID="lbSubmitAddshenqing" runat="server" Text="修改" class="buttonSubmit" Width="80px"  BorderColor="#EEEEEE" />
                </td>
