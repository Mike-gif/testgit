<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="edit_ShenQingShenBao_qingjia.aspx.cs" Inherits="user_edit_ShenQingShenBao_qingjia" %>
    ...
    <div style="margin-left: 40px; text-align: center" id="div_cont">
        ...
        <table style="width: 90%; padding-top: 5px; text-align:center ">
           ...
           <tr>
                ...
                <td style= "width: 80px">
                    <asp:Button ID="lbSubmitAddzhou" runat="server" Text="修 改"  class="buttonSubmit" Width="80px"  BackColor="#EEEEEE"/>
            ...
            <tr>
                ...
                <td style="width: 100px" >
                    <asp:TextBox ID="r_time" runat="server" ReadOnly="true"  Width="80px" align="center" BackColor="#EEEEEE"></asp:TextBox>
