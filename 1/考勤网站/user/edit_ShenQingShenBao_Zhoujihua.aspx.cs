...
public partial class user_edit_ShenQingShenBao_ZhouJiHua : System.Web.UI.Page
{
  ...
  /*   protected void gvShow_Sorting(object sender, GridViewSortEventArgs e)
    ...
    */
    ...
    /*     String sql9 = "SELECT * FROM [ZhouJiHua] where z_time='" + z_time.Text + "' and z_number='" + Session["number"] + "'";
         DataTable dt_allgongzuori1 = SqlHelper.ExecuteDataTable(sql9);
         int i_all = dt_allgongzuori1.Rows.Count;


         String sql10 = "SELECT * FROM [ShenQingShenBao] where s_time='" + z_time.Text + "' and s_number='" + Session["number"] + "' and s_leibie='周计划'";
         // System.Diagnostics.Debug.Assert(false, sql19);//打印调试信息
         DataTable dt_allgongzuori2 = SqlHelper.ExecuteDataTable(sql10);
