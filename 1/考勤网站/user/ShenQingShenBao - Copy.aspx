<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="ShenQingShenBao - Copy.aspx.cs" Inherits="user_ShenQingShenBao" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="_head" runat="Server">
    <script type="text/javascript">
        ...
        function checkdatashenqing() {
            ...
            return confirm('请确认天数/小时数填写正确：请假(按天计算)、加班(按小时计算),请注意区分，填写数值,如0.5!');
    ...
    <div style="margin-left: 40px; text-align: center" id="div_cont">
        ...
        <asp:GridView ID="gvShow" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="s_statue" HeaderText="状态" SortExpression="s_statue" ItemStyle-Width="25%" HeaderStyle-Width="25%" ItemStyle-HorizontalAlign="Center">
                    <ItemStyle Width="25%" />
                </asp:BoundField>
