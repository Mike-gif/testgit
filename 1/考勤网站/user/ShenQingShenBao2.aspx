<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="ShenQingShenBao2.aspx.cs" Inherits="user_ShenQingShenBao2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="_head" runat="Server">
    <script type="text/javascript">
        ...
        function checkdatazhou() {
            ...
            return confirm('请确定开始新的一周，填写新的周计划？');
            }
        ...
        function checkdatashenqing() {
            ...
            var tianall = document.getElementById("tianall").value;
            if (tianall == "") {
            ...
            return confirm('请确定天数/小时数填写正确：请假(按天计算)、加班(按小时计算),请注意区分，填写数值,如0.5!');
        ...
        <table style="width: 90%; padding-top: 5px; text-align:center ">
           ...
           <tr>
                ...
                <td style= "width: 120px">
                    <asp:Button ID="Btnzhou" runat="server" Text="填写新的周计划" Width="120px"  OnClick="Btnzhou_Click" OnClientClick="return checkdatazhou()" />
                ...
                <asp:TemplateField HeaderText="详细操作" HeaderStyle-Width="30%">
                    <ItemTemplate>
                        ...
                        <asp:LinkButton ID="lbDelete" runat="server" CausesValidation="False" CommandName="Delete"
                            CommandArgument='<%# Eval("id") %>' Text="删除" HeaderStyle-Width="15%"></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
