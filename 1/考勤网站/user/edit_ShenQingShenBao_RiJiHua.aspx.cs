...
public partial class user_edit_ShenQingShenBao_RiJiHua : System.Web.UI.Page
{
...
*/
     ...
     protected void lbSubmitAddri_Click(object sender, EventArgs e)  //日计划
    {
     ...
     /*   String sql9 = "SELECT * FROM [RiJiHua] where r_time='" + r_time.Text + "' and r_number='" + Session["number"] + "'";
        DataTable dt_allgongzuori1 = SqlHelper.ExecuteDataTable(sql9);
        int i_all = dt_allgongzuori1.Rows.Count;


        String sql10 = "SELECT * FROM [ShenQingShenBao] where s_time='" + r_time.Text + "' and s_number='" + Session["number"] + "' and s_leibie='日计划'";
