...
public partial class user_edit_ShenQingShenBao_qingjia : System.Web.UI.Page
{
...
*/
     ...
     protected void lbSubmitAddzhou_Click(object sender, EventArgs e)  //周计划
     {
         ...
         if (Session["number"] == null)
         {
          ...
          string sql6 = "update [ZhouJiHua] set z_jihua=@z_jihua,z_mubiao=@z_mubiao,z_zhanbi=@z_zhanbi,z_shishiqingkuang=@z_shishiqingkuang,z_jieguo=@z_jieguo,z_time=@z_time where id=" + _ID.Text;
        ...
        // System.Diagnostics.Debug.Assert(false, sql6);//打印调试信息
         SqlParameter[] sps6 = new SqlParameter[6];
         ...
         string sql7 = "update [ShenQingShenBao] set s_time=@s_time where id=" + _ID.Text;
         SqlParameter[] sps7 = new SqlParameter[1];
         sps7[0] = new SqlParameter("@s_time", r_time.Text);
     ...
     protected void lbSubmitAddri_Click(object sender, EventArgs e)  //日计划
    {
        ...
        string sql4 = "update [RiJiHua] set r_jihua=@r_jihua,r_mubiao=@r_mubiao,r_gongshi=@r_gongshi,r_neirong=@r_neirong,r_jieguo=@r_jieguo,r_time=@r_time where id=" + _ID.Text;
        ...
        string sql5 = "update [ShenQingShenBao] set s_time=@s_time where id=" + _ID.Text;
        SqlParameter[] sps5 = new SqlParameter[1];
     ...
     protected void lbSubmitAddshenqing_Click(object sender, EventArgs e)   //请假 (请假的申请日期可能改变，但填写日期不变，所以不用更新[ShenQingShenBao])
    {
        ...
        {
            string sql8 = "update [qingjia] set q_startdate=@c_startdate,q_enddate=@c_enddate,q_things=@c_things,q_shixiang=@q_shixiang,q_statue=@q_statue,q_all=@q_all,ImageUrl=@ImageUrl where Q_ID=" + _ID.Text;
            SqlParameter[] sps8 = new SqlParameter[7];
            ...
            sps8[4] = new SqlParameter("@q_statue", "0");
            sps8[5] = new SqlParameter("@q_all", tianall.Text);
            sps8[6] = new SqlParameter("@ImageUrl", this.Label2.Text);
