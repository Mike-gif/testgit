<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="ChaKanRiJiHua.aspx.cs" Inherits="user_ChaKanRiJiHua" %>
...
<asp:Content ID="Content3" runat="server" contentplaceholderid="mainContent" ClientIDMode="Static">
    <div style="margin-left: 10px; text-align: center">
        ...
        <asp:Table ID="tb_result" runat="server" Width="100%" >
