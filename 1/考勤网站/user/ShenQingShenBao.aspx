<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="ShenQingShenBao.aspx.cs" Inherits="user_ShenQingShenBao" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="mainContent" ClientIDMode="Static">
    <div style="margin-left: 40px; text-align: center" id="div_cont">
        ...
        <asp:GridView ID="gvShow" runat="server" AutoGenerateColumns="False" DataKeyNames="id" 
            ...
            OnRowDataBound="gvShow_RowDataBound" OnRowCommand="gvShow_RowCommand" OnSorting="gvShow_Sorting" Mode="NumericFirstLast">
