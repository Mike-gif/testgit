<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="edit_ShenQingShenBao_Zhoujihua.aspx.cs" Inherits="user_edit_ShenQingShenBao_ZhouJiHua" %>
           ...
           <tr>
            ...
            <tr>
                ...
                <td  style= "width: 80px">
                     ...
                     <asp:Button ID="lbSubmitAddri" runat="server" Text="修 改"  class="buttonSubmit" Width="80px"  BackColor="#EEEEEE"/>
                </td>
            </tr>
