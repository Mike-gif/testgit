...
public partial class admin_YuanGongInf : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sql4 = "insert into [userinfo](cardid1,name,number,zaizhi,Banci,cardid2,cardid3,shangji,kaoqinadmin,jibie,canbu,chebu,password)values(@cardid1,@name,@number,@zaizhi,@Banci,@cardid2,@cardid3,@shangji,@kaoqinadmin,@jibie,@canbu,@chebu,@password)";
        SqlParameter[] sps4 = new SqlParameter[13];
