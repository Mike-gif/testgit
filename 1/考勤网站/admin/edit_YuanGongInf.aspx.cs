...
public partial class admin_edit_YuanGongInf : System.Web.UI.Page
{
   // userinfo person = null;
    ...
    protected void lbSubmitAdd_Click(object sender, EventArgs e)
    {
        ...
        string sql1 = "update [userinfo] set cardid1=@cardid1,name=@name,number=@number,zaizhi=@zaizhi,Banci=@Banci,cardid2=@cardid2,cardid3=@cardid3,shangji=@shangji,kaoqinadmin=@kaoqinadmin,jibie=@jibie,canbu=@canbu,chebu=@chebu where id=" + _ID.Text;
